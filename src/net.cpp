...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Menlocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    //{"menlocointools.com", "dnsseed.menlocointools.com"},
    //{"menlocoinpool.org", "dnsseed.menlocoinpool.org"},
    //{"xurious.com", "dnsseed.mlc.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    //{"menlocointools.com", "testnet-seed.menlocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Menlocoin is probably already running."), addrBind.ToString().c_str());
        else
